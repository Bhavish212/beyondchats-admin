...
const Analytics = () => {
  ...
  return (
    <motion.div
      ...
      className="p-6 max-w-6xl mx-auto bg-gradient-to-br from-blue-50 to-teal-100 dark:from-gray-900 dark:to-gray-800 rounded-xl"
    >
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-3xl font-bold text-blue-700 dark:text-white">Analytics</h2>
